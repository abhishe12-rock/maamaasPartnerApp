...
import 'package:maamaaspartner/food&beverages/support_team.dart';
import 'package:maamaaspartner/user_module/Models/dummyuser.dart';
...
class _ProfileState extends State<Profile> {
  ...
  final DummyUserProfile staticUser = DummyUserProfile()
    ..userName = "Mahesh"
    ...
    ..occupationSubType = "IT / Software"
    ..interests = ["Food", "Tech", "Travel"];

  @override
  Widget build(BuildContext context) {
    final completion = ProfileCompletionService.calculate(staticUser);
            ...
            children: [
              ...
              Text(
                completion < 40
                    ...
                    : completion < 70
                    ? "Add more details to unlock benefits 🎯"
                    : completion < 100
                    ? "Almost done 🎁"
                    : "Profile complete 🎉",
