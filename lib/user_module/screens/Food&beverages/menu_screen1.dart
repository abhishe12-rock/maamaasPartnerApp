...
// // import 'package:maamaas_app/screens/Food&beverages/Table.dart';
...
// // import 'dishsearchdeligate.dart';
...
// //               ),
// //             ),
// //             // Updated MenuFilterBar with categories as tabs
...
// //                         child: (showMenuTab && selectedTabIndex == 0)
// //                             ? AnimatedOpacity(
...
// //                 child: Builder(
// //                   builder: (_) {
// //                     // 🔥 CASE 1: TABLE_DINE_IN + PREMIUM → Only show TableTabContent
// //                     if (showTableTab) {
// //                       return TableTabContent(vendorId: widget.vendorId);
// //                     }
// //
// //                     // 🔥 CASE 2: All other order types → Menu or table based on tab index
// //                     if (showMenuTab && _selectedIndex == 0) {
...
// //       floatingActionButton: showMenuTab
// //           ? Padding(
// //         padding: const EdgeInsets.only(left: 16, bottom: 1),
// //         child: Align(
// //           alignment: Alignment.bottomRight,
// //           child: SizedBox(
// //             width: 120, // width of the floating cart button
// //             child: OrderCart(), // your footer widget
// //           ),
// //         ),
// //       )
// //           : null,
...
// //       return 135; // 60 for filter bar + 80 for categories
// //     } else {
// //       // When only filter bar is visible
// //       return 60;
// //     }
// //   }
// //
...
// //     _initializeData();
// //
// //     // FIX: Set proper tab only once at start
...
// //                         context: context,
// //                         delegate: DishSearchDelegate(vendorId: widget.vendorId),
// //                       );
// //
// //                       if (result != null && result.isNotEmpty) {
// //                         // print("Selected dish: $result");
// //                       }
// //                     },
// //                     child: Container(
...
// //
// //         // Filter dishes
// //         final filteredDishes = snapshot.data!.where((dish) {
// //           final isEnabled = dish.menuStatus == "Enable";
// //
// //           // 👇 Show ALL
// //           if (widget.filterTag == null) return isEnabled;
// //
// //           // 👇 Veg / Non-Veg
// //           return isEnabled &&
...
// //                   ? null
// //                   : () {
// //                 showDishBottomSheet(context, dish);
// //               },
// //               child: ProductCard(
...
// import '../../Models/food/restaurent_banner_model.dart';
// import '../../Models/food/timings_model.dart';
// import '../../widgets/food/footer.dart';
// import '../cartbutton.dart';
// import '../../widgets/food/cart_button.dart';
// import '../../widgets/food/favorite_button.dart';
// import '../../widgets/food/switch.dart';
