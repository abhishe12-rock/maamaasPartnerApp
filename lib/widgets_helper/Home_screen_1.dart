...
// // import '../Sales & Leads/screens/quotation_screen.dart';
...
// //       children: [
// //         if (hasPendingOrders) _buildFooterOrdersBar(),
// //         Container(
// //           decoration: BoxDecoration(
// //             color: _H.white,
...
// //   }
// //
// //   Widget _buildFooterOrdersBar() {
// //     final orders = _pendingPopupOrders;
// //
// //     return Container(
// //       decoration: BoxDecoration(
// //         color: _H.white,
...
// //                   activeColor: _H.blue,
// //                   bgColor: _printEnabled
// //                       ? _H.blueLight
// //                       : const Color(0xFFF3F4F6),
// //                   isActive: _printEnabled,
// //                   onTap: _togglePrint,
// //                 ),
// //               ],
// //             ),
...
// //                   onAccept: () {
// //                     if (_printEnabled) {
// //                       _openPrinterSheet(order);
// //                     } else {
// //                       _acceptOrderFromPopup(order);
// //                     }
// //                   },
// //                   onDecline: () => _declineOrderFromPopup(order),
// //                 );
// //               },
// //             ),
// //           ),
...
//     for (var item in items) {
//       if (item is! Map) continue;
//       String dishName = (item['dishName'] ?? item['itemsName'] ?? 'N/A').toString();
//       if (dishName.length > 26) dishName = dishName.substring(0, 26);
//       final qty = (item['quantity'] ?? 1).toString();
//
//       await PrintBluetoothThermal.writeString(
...
//               decoration: const BoxDecoration(
//                 gradient: LinearGradient(
//                   colors: [_H.accent, Color(0xFFFF8A50)],
//                 ),
//                 borderRadius: BorderRadius.vertical(top: Radius.circular(20)),
//               ),
//               child: Column(
...
//                           final item = items[i];
//                           final name =
//                               (item['dishName'] ?? item['itemsName'] ?? 'Item')
//                                   .toString();
//                           final qty = (item['quantity'] ?? 1).toString();
