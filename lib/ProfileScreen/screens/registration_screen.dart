...
//   void dispose() {
//     for (final c in [
//       _companyNameCtrl, _positionCtrl, _contactNameCtrl,
//       _phoneCtrl, _emailCtrl, _aadharCtrl, _gstCtrl,
//       _doorCtrl, _streetCtrl, _cityCtrl, _stateCtrl,
//       _pincodeCtrl, _landmarkCtrl,
//       _holderCtrl, _accCtrl, _branchCtrl, _ifscCtrl,
//       _tradeNumCtrl, _tradeStartCtrl, _tradeEndCtrl,
//       _fssaiNumCtrl, _fssaiStartCtrl, _fssaiEndCtrl,
//       _labourNumCtrl, _labourStartCtrl, _labourEndCtrl,
//     ]) {
//       c.dispose();
//     }
//     super.dispose();
...
//           if (_doorCtrl.text.isNotEmpty)
//             _fieldStatus['Address'] = 'Provided';
...
//                 SizedBox(width: 8),
//                 Text('Fill in all details to complete registration',
//                     style: TextStyle(
//                         color: kWarning,
...
//               //       ? null
//               //       : (v) =>
//               //           setState(() => _businessVertical = v ?? _businessVertical),
//               // ),
//               const SizedBox(height: 12),
//               FormTile(
//                   label: 'Position',
...
//               //   value: _verticalType,
//               //   options: const [
//               //     'HOTEL', 'RESTAURANT', 'CAFE', 'CLOUD_KITCHEN',
//               //     'FOOD_COURT', 'STREET_FOOD', 'BAKERY'
//               //   ],
//               //   onChanged: _canEdit
//               //       ? null
//               //       : (v) =>
//               //           setState(() => _verticalType = v ?? _verticalType),
//               // ),
//             ],
//           ),
//
